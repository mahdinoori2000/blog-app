...
RSpec.feature 'User Index Page', type: :feature do
    before do
        @user1 = User.create(name: 'Sam', photo: 'https://icons.iconarchive.com/icons/iconsmind/outline/256/User-icon.png', bio: 'Teacher from Poland.', post_counter: 1)
        @user2 = User.create(name: 'John', photo: 'https://example.com/user2.jpg',  bio: 'Developer from USA.', post_counter: 3)
    visit root_path
    end
